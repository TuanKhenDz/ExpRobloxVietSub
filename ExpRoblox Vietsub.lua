--[[
Cảm Ơn Bạn Đã Sử Dụng Script Của ExpRoblox :D
]]--
...
local Window = OrionLib:MakeWindow({Name = "ExpRoblox", HidePremium = false, IntroText = "ExpRoblox Library", SaveConfig = true, ConfigFolder = "ExpRoblox Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "rbxassetid://16327363662",
    PremiumOnly = false
})
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "ExpRoblox Hub(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://16327363662",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "ExpRoblox Hub(Noitification)",
